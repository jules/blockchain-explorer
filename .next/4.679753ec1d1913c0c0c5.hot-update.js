...
(function () {
  ...
  reactHotLoader.register(_default, "default", "/Users/julesdesmit/Desktop/workspace/explorer/components/Header.js");
  leaveModule(module);
})();
...
function (_Component) {
  ...
  _createClass(ExplorerIndex, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 2;
                _context2.next = 5;
                return __WEBPACK_IMPORTED_MODULE_2__scripts_web3__["a" /* default */].eth.getTransaction(this.state.search);

              case 5:
                __WEBPACK_IMPORTED_MODULE_6__routes__["Router"].pushRoute("/transaction/".concat(this.state.search));
                _context2.next = 12;
                break;
              ...
              case 14:
                if (!(this.state.search.length == 42)) {
                  _context2.next = 27;
                  break;
                }
              ...
              case 18:
                __WEBPACK_IMPORTED_MODULE_6__routes__["Router"].pushRoute("/address/".concat(this.state.search));
                _context2.next = 25;
                break;
              ...
              case 27:
                _context2.prev = 27;
                block = parseInt(this.state.search);
                _context2.next = 31;
                return __WEBPACK_IMPORTED_MODULE_2__scripts_web3__["a" /* default */].eth.getBlock(block);

              case 31:
                __WEBPACK_IMPORTED_MODULE_6__routes__["Router"].pushRoute("/blocknumber/".concat(this.state.search));
                _context2.next = 38;
                break;
    ...
    value: function render() {
      ...
      var Header = __WEBPACK_IMPORTED_MODULE_5_semantic_ui_react__["f" /* Table */].Header,
          Row = __WEBPACK_IMPORTED_MODULE_5_semantic_ui_react__["f" /* Table */].Row,
          HeaderCell = __WEBPACK_IMPORTED_MODULE_5_semantic_ui_react__["f" /* Table */].HeaderCell,
          Body = __WEBPACK_IMPORTED_MODULE_5_semantic_ui_react__["f" /* Table */].Body;
      ...
      if (this.state.blockNumber == 0) {
        ...
        }), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_semantic_ui_react__["f" /* Table */], {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 101
          }
...
(function () {
  ...
  reactHotLoader.register(routes, "routes", "/Users/julesdesmit/Desktop/workspace/explorer/routes.js");
  leaveModule(module);
})();
...
//# sourceMappingURL=4.679753ec1d1913c0c0c5.hot-update.js.map